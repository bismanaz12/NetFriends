...
import 'package:social_app2/comment_screen.dart';
...
import 'package:social_app2/status.dart';
          ...
          children: [
            Padding(
              ...
              child: Container(
                ...
                child: InkWell(
                  onTap: (){
                    Navigator.push(context, MaterialPageRoute(builder: (context) => OtherUserProfile(userId: widget.post.userUid),));
                  },
                  child: Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
